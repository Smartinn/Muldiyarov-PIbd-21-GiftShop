...
namespace GiftShopRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<DbContext, GiftDBContext>(new HierarchicalLifetimeManager());
            ...
            container.RegisterType<IFacilitatorService, FacilitatorServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IGiftService, GiftServiceBD>(new HierarchicalLifetimeManager());
