    ...
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="dataGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" ShowHeaderWhenEmpty="True">
            <Columns>
                ...
                <asp:BoundField DataField="FacilitatorName" HeaderText="Исполнитель" SortExpression="FacilitatorName" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="GiftShopService.CoverModels.CustomCoverModel" DeleteMethod="PayCustom" InsertMethod="CreateCustom" SelectMethod="GetList" TypeName="GiftShopService.InventoryDB.MainServiceBD" UpdateMethod="TakeCustom">
            <DeleteParameters>
