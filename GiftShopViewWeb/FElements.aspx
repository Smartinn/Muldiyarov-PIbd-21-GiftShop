...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="GiftShopService.InventoryDB.ElementServiceBD"></asp:ObjectDataSource>
        </div>
    </form>
</body>
</html>
