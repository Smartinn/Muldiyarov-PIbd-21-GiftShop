<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FElements.aspx.cs" Inherits="GiftShopViewWeb.FElements" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="GiftShopServiceWeb.InventoryList.ElementServiceList"></asp:ObjectDataSource>
        </div>
    </form>
</body>
</html>
