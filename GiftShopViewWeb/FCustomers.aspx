...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="GiftShopService.InventoryDB.CustomerServiceBD"></asp:ObjectDataSource>
        </div>
    </form>
</body>
</html>
