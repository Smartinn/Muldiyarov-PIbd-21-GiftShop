<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FCustom.aspx.cs" Inherits="GiftShopViewWeb.FCustom" %>
...
<body>
    <form id="form1" runat="server">
        <div>
        <asp:Label ID="Name" runat="server" Width ="120px">Клиент</asp:Label>
        <asp:DropDownList ID="DropDownListCustomer" runat="server" Height="16px" Width="285px">
        </asp:DropDownList>
        <br />
        <br />
        <asp:Label ID="Label1" runat="server" Width ="120px">Подарок</asp:Label>
        <asp:DropDownList ID="DropDownListService" runat="server" Height="16px" OnSelectedIndexChanged="DropDownListService_SelectedIndexChanged" Width="285px" AutoPostBack="True">
        </asp:DropDownList>
        <br />
        <br />
        ...
        <br />
        <br />
        <asp:Label ID="Label3" runat="server" Width ="120px">Сумма</asp:Label> 
