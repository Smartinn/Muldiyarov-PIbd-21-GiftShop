...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="GiftShopServiceWeb.InventoryLIst.FacilitatorServiceList"></asp:ObjectDataSource>
        </div>
        </div>
    </form>
</body>
